...
import { attributeStats, checkDropdown } from "../schemaVariables/schemaVariables";
...
type ValidationRule = {
  ...
  export default {
    ...
    type: "document",
    fields: [
      //! code below not needed as we dont wanna create a new name for the class.
      // {
      //   name: "name",
      //   title: "Name",
      //   type: "string",
      ...
      //! made redundent because of the code above.
      // {
      //   name: "classType",
