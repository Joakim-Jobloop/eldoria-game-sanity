  ...
  fields: [
    {
      ...
      type: 'string',
      validation: (Rule: ValidationRule) => Rule.required().error('Race name is required'),
    },
    {
      name: 'description',
      title: 'Description',
    ...
    },
    {
      ...
      options: {
        layout: 'radio',
        list: [
          //TODO: this list should be defined in fundamentals -> characterRaces
          //? Look at how its done in the other fundemantels -> files there
          //TODO: create a new schemaVariable for this part. Base it on checkDropDown, but instead of layout: grid you can use radio as you did here
