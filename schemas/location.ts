...
export default {
  ...
  type: 'document',
  fields: [
    { name: 'name', title: 'Location Name', type: 'string', validation: (Rule: ValidationRule) => Rule.required() },
    ...
    { name: 'portrait', title: 'Visual / Environment Image', type: 'image', options: { hotspot: true } },
    ...
    { name: 'resourceTags', title: 'Common Resources or Materials', type: 'array', of: [{ type: 'string' }] },
    { name: 'enemyFactions', title: 'Enemy Factions Present', type: 'array', of: [{ type: 'string' }] },
